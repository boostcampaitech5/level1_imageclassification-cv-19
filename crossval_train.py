...
def train(data_dir, model_dir, args):
    ...
    wandb.init(project='lv1-cv19-nayoung', entity='level1-cv19', name=args.model, config=vars(args))
    ...
    # -- data_loader #여기 수정해서 cross-val 
    splits = KFold(n_splits=5, shuffle=True, random_state=42)
    
    for fold, (train_idx, val_idx) in enumerate(splits.split(len(dataset))):
