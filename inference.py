...
from dataset import TestDataset, MaskBaseDataset, AgeGenderDataset, MaskOnlyDataset
...
def inference(data_dir, model_dir, output_dir, args):
    ...
    info['ans'] = preds
    save_path = os.path.join(output_dir, f'output_final.csv')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str, default=os.environ.get('SM_CHANNEL_MODEL', './model/DenseNet121_scheduler1'))
