...
class AgeGenderDataset(Dataset): #age와 gender를 최종 라벨로 하는 dataset 
    num_classes = 3 * 2
    ...
    @staticmethod
    def decode_multi_class(multi_class_label) -> Tuple[GenderLabels, AgeLabels]:
...
class AgeDataset(Dataset): #age를 최종 라벨로 하는 dataset 
    num_classes = 3 
    ...
    @staticmethod
    def encode_multi_class(age_label) -> int:
        return age_label
...
class MaskOnlyDataset(Dataset): #mask착용 여부를 최종 라벨로 하는 dataset 
    num_classes = 3
    ...
    @staticmethod
    def encode_multi_class(mask_label) -> int:
        return mask_label

    @staticmethod
    def decode_multi_class(multi_class_label) -> Tuple[MaskLabels]:
